...
public class P698Utils {
    ...
    public static class P698MsgBuilder {
        ...
        public byte[] build() {
            ...
            System.out.println("进行HCS校验的数据: " + HexUtils.bytesToHexString(bytes2HCS));
            ...
            System.out.println("进行FCS校验的数据: " + HexUtils.bytesToHexString(bytes2FCS));
        ...
        public P698MsgBuilder addAttr(AttrEnum attrEnum) {
            ...
            System.out.println(HexUtils.bytesToHexString(appType));
            return this;
        }
    }
